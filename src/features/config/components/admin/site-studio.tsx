...
export function SiteStudio() {
  ...
  return (
    <div className="site-studio">
      ...
      <SettingsDisclosure
        className="site-cuckoo-settings"
        title={
          <span className="site-section-copy">
            <strong>Cuckoo</strong>
            <span className="site-section-hint">
              {m.settings_site_field_default_cover_hint_cuckoo({
                slug: "{slug}",
              })}
            </span>
          </span>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <label className="site-section-copy">
            <span>{m.settings_site_field_home_image()}</span>
            <input
              {...register("site.theme.cuckoo.bg")}
              className={SETTINGS_FIELD_CLASS}
              placeholder="/images/themes/cuckoo/bg.svg"
            />
          </label>
          <label className="site-section-copy">
            <span>{m.settings_site_field_avatar()}</span>
            <input
              {...register("site.theme.cuckoo.avatar")}
              className={SETTINGS_FIELD_CLASS}
              placeholder="/images/themes/cuckoo/avatar.svg"
            />
          </label>
          <label className="site-section-copy">
            <span>{m.settings_site_field_sidebar_image_cuckoo()}</span>
            <input
              {...register("site.theme.cuckoo.sidebarBg")}
              className={SETTINGS_FIELD_CLASS}
              placeholder="/images/themes/cuckoo/sidebar.svg"
            />
          </label>
          <label className="site-section-copy">
            <span>{m.settings_site_field_default_cover_cuckoo()}</span>
            <input
          ...
          <label className="site-section-copy">
            <span>{m.settings_site_field_primary_hue()}</span>
            <input
              {...register("site.theme.cuckoo.primaryHue", {
                valueAsNumber: true,
              })}
              type="number"
              min={0}
